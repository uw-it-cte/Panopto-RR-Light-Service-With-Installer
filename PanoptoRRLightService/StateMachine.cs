...
namespace RRLightProgram
{
    public class StateMachine : IStateMachine
    {
        ...
        private void InitializeTransitionTable()
        {
            ...
            this.transitionTable.Add(new Condition(State.PreviewingNoNextSchedule, Input.Start), new Transition(this.ActionRequestNewRecording, State.TransitionAnyToRecording));
            ...
            this.transitionTable.Add(new Condition(State.PreviewingWithNextSchedule, Input.Start), new Transition(this.ActionRequestNextRecording, State.TransitionAnyToRecording));
            ...
            this.transitionTable.Add(new Condition(State.Recording, Input.Stop), new Transition(this.ActionRequestStop, State.TransitionRecordingToStop));
            this.transitionTable.Add(new Condition(State.Recording, Input.Pause), new Transition(this.ActionRequestPause, State.TransitionRecordingToPause));
            this.transitionTable.Add(new Condition(State.Recording, Input.Extend), new Transition(this.ActionRequestExtend, State.Recording));
            ...
            this.transitionTable.Add(new Condition(State.Paused, Input.Stop), new Transition(this.ActionRequestStop, State.TransitionPausedToStop));
            this.transitionTable.Add(new Condition(State.Paused, Input.Resume), new Transition(this.ActionRequestResume, State.TransitionAnyToRecording));
            this.transitionTable.Add(new Condition(State.Paused, Input.Extend), new Transition(this.ActionRequestExtend, State.Paused));
